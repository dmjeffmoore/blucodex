    ...
    render() {
        return (
            <div className="legal pt-5">
                ...
                <p>You must not:</p>
                <ol>
                    <li>Republish material from http://www.blucodex.com</li>
                    <li>Sell, rent or sub-license material from http://www.blucodex.com</li>
                    <li>Reproduce, duplicate or copy material from http://www.blucodex.com</li>
                </ol>
                <p>Redistribute content from Blucodex Technology Consulting (unless content is specifically made for redistribution).</p>
                ...
                <p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect
                    ...
                    the visibility associated with the hyperlink outweighs the absence of Blucodex Technology Consulting and (d) where the
                ...
                <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
                    you must notify us by sending an e-mail to <a href="mailto:someEmail@email.com" title="send an email to someEmail@email.com">someEmail@email.com</a>.
                ...
                <p>No use of Blucodex Technology Consulting’s logo or other artwork will be allowed for linking absent a trademark license
                    agreement.</p>
                <h2>Iframes</h2>
